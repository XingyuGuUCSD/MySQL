...
select CustID, CreditCardTotalCredit, CreditCardBalance, CreditCardAvailableCredit as old_credit_card_available_credit, CreditCardTotalCredit - CreditCardBalance as new_credit_card_available_credit
       from CustBal
       where ActiveStatus = 1;
select CustID, CheckingBalance, SavingsBalance, CreditCardBalance, TotalBalance as old_total_balance, CheckingBalance + SavingsBalance - CreditCardBalance as new_total_balance
       from CustBal
       where ActiveStatus = 1;
Update CustBal
